      ...
      <div className="min-h-screen">
        ...
        <section className="relative h-screen flex flex-col justify-center">
          ...
          <div className="relative z-10 max-w-4xl mx-auto text-center px-4 mb-16">
            ...
            >
              Transformez votre business grâce à la puissance de l'intelligence artificielle.
            </motion.p>
          </div>
            ...
            >
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Créez du contenu unique et pertinent automatiquement.
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Dialoguez naturellement avec vos clients 24/7.
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Anticipez les tendances grâce à l'analyse prédictive.
                  </p>
                </div>
              </motion.div>
            </motion.div>
